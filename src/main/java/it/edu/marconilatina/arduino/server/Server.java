...
//                String data;
//                while ((data = in.readLine()) != null && running) {
//                	try {
//                        double value = Double.parseDouble(data);
//                        
//                        // Genero l'evento per comunicare la lettura dei dati
//                        out.println("Dati ricevuti con successo");
//                    } catch (NumberFormatException e) {
//                        System.err.println("Errore nel formato del dato: " + data);
//                    }
//                }
			}
